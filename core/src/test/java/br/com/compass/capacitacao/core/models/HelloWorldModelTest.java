...
import br.com.compass.capacitacao.core.models.another.HelloWorldModel;
...
import br.com.compass.capacitacao.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "capacitacao/components/helloworld");
